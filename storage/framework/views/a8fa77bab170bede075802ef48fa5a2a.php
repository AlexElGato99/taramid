<?php
    ...
    $footerDesc = setting('footer_description', 'Natural extracts from aromatic and medicinal plants of the Moroccan Middle Atlas.');
    $copyright = setting('footer_copyright', 'Taramide Cosmetics');
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        <div class="py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            <div class="lg:col-span-1 text-center md:text-start">
                <div class="mb-4 flex justify-center md:justify-start">
                    <?php if($footerLogo): ?>
                        <img src="<?php echo e(asset('storage/' . $footerLogo)); ?>" alt="<?php echo e(setting('name', 'Taramide')); ?>" class="object-contain" style="height: <?php echo e($logoHeight); ?>px;">
                    <?php elseif(setting('logo')): ?>
                        <img src="<?php echo e(asset('static/img/' . setting('logo'))); ?>" alt="<?php echo e(setting('name', 'Taramide')); ?>" class="object-contain brightness-0 invert" style="height: <?php echo e($logoHeight); ?>px;">
                    <?php endif; ?>
                </div>
            ...
            <div class="text-center md:text-start">
                <div class="text-[11px] font-medium text-white/30 mb-4"><?php echo e($col['title'] ?? ''); ?></div>
                <div class="space-y-2.5">
                    <?php $__currentLoopData = $col['lines'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($line['url'])): ?>
                            <a href="<?php echo e($line['url']); ?>" class="block text-sm text-white/50 hover:text-white transition-colors"><?php echo e($line['text']); ?></a>
                        <?php else: ?>
                            <p class="text-sm text-white/50"><?php echo e($line['text']); ?></p>
                        <?php endif; ?>
        ...
        <div class="border-t border-white/5 py-5 flex items-center justify-center">
            <div class="text-[11px] text-white/20">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($copyright); ?> &middot; All rights reserved
            </div>
        </div>
    </div>
</footer>

<a href="https://wa.me/<?php echo e($whatsapp); ?>" target="_blank" rel="noopener noreferrer"
...
<?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/sections/footer.blade.php ENDPATH**/ ?>