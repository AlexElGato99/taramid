...
<?php if($languages->count() > 1): ?>
    ...
    <?php if (! $__env->hasRenderedOnce('0759ea93-283e-4ef8-83b1-f33377b54df2')): $__env->markAsRenderedOnce('0759ea93-283e-4ef8-83b1-f33377b54df2'); ?>
        <?php $__env->startPush('javascript'); ?>
            <script>
                (function () {
                    var RTL_LOCALES = <?php echo json_encode(config('languages.rtl', []), 512) ?>;
