...
<section id="process" class="py-24 lg:py-32 bg-white">
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        <div class="text-center max-w-xl mx-auto mb-16 reveal">
            <div class="badge mx-auto mb-6"><?php echo e(setting('process_badge', 'Our Process')); ?></div>
            <h2 class="font-display text-heading text-ink leading-tight">
                <?php echo e(setting('process_heading_line1', 'From plant to bottle,')); ?><br><?php echo e(setting('process_heading_line2', 'a unique expertise')); ?>
