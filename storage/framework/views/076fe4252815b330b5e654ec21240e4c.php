...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto w-full">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.lang-select','data' => ['fields' => (new \App\Models\Category)->translatableFields()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute((new \App\Models\Category)->translatableFields())]); ?>
...
<?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm p-6 lg:p-8">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">
                <?php echo e(isset($listing) ? __('Edit Category') : __('Add Category')); ?>

            </h2>

            <form method="POST"
                  action="<?php echo e(isset($listing) ? route('admin.categories.update', $listing->id) : route('admin.categories.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                            <x-form.input id="name" name="name" type="text" class="mt-1 block w-full"
                                          :value="old('name', model_value($listing ?? null, 'name', ''))" <?php echo e(admin_locale() === base_locale() ? 'required' : ''); ?> placeholder="<?php echo e(model_placeholder($listing ?? null, 'name', __('e.g. Essential Oils'))); ?>"/>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.error','data' => ['class' => 'mt-2','messages' => $errors->get('name')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/admin/categories/form.blade.php ENDPATH**/ ?>