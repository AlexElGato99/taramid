...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(__('Slider')); ?></h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('Manage the scrolling slider items on the homepage')); ?></p>
            </div>
            <a href="<?php echo e(route('admin.slider-items.create')); ?>"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($listing->logo): ?>
                                        <img src="<?php echo e(asset('storage/' . $listing->logo)); ?>" alt="" class="h-8 w-8 rounded object-contain bg-gray-100 dark:bg-gray-800">
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($listing->text); ?></div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="<?php echo e(route('admin.slider-items.edit', $listing->id)); ?>"
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.slider-items.destroy', $listing->id)); ?>"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="text-gray-400 dark:text-gray-500">
                                        ...
                                        <p class="text-sm"><?php echo e(__('No slider items yet.')); ?></p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/admin/slider-items/index.blade.php ENDPATH**/ ?>