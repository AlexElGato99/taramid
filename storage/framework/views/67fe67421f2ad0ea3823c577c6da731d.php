...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(__('Our Products')); ?></h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('Manage your product catalog')); ?></p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($listing->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $listing->image)); ?>" alt="" class="h-12 w-12 rounded-lg object-cover bg-gray-100 dark:bg-gray-800">
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <?php if($listing->badge): ?>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400 mt-1"><?php echo e($listing->badge); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($listing->category): ?>
                                        <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($listing->category->name); ?></span>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="<?php echo e(route('products.show', $listing->slug)); ?>" target="_blank"
                                           class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors" title="<?php echo e(__('View')); ?>">
                                        ...
                                        <a href="<?php echo e(route('admin.products.edit', $listing->slug)); ?>"
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.products.destroy', $listing->slug)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/admin/products/index.blade.php ENDPATH**/ ?>