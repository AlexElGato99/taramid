...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto w-full">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('admin.process-steps.index')); ?>" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 mb-3">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                <?php echo e(__('Back to Process Steps')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.lang-select','data' => ['fields' => (new \App\Models\ProcessStep)->translatableFields()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute((new \App\Models\ProcessStep)->translatableFields())]); ?>
...
<?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm p-6 lg:p-8">
            <form method="POST"
                  action="<?php echo e(isset($listing) ? route('admin.process-steps.update', $listing->id) : route('admin.process-steps.store')); ?>"
...
<?php endif; ?>
                            <x-form.input id="title" name="title" type="text" class="mt-1 block w-full" <?php echo e(admin_locale() === base_locale() ? 'required' : ''); ?>
                                          ...
                                          :value="old('title', model_value($listing ?? null, 'title', ''))" placeholder="<?php echo e(model_placeholder($listing ?? null, 'title', __('e.g. Cultivation'))); ?>"/>
                        </div>
...
<?php endif; ?>
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  placeholder="<?php echo e(model_placeholder($listing ?? null, 'description', __('Step description'))); ?>"><?php echo e(old('description', model_value($listing ?? null, 'description', ''))); ?></textarea>
                    </div>
...
<?php endif; ?>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('Upload an icon image for this step')); ?></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/admin/process-steps/form.blade.php ENDPATH**/ ?>