    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="group reveal <?php echo e($index > 0 ? 'reveal-delay-' . $index : ''); ?>">
        ...
        <div class="text-center mt-12 reveal">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-ghost py-3 px-8 text-sm">
                <?php echo e(__('Show More Products')); ?>
...
<?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/sections/products.blade.php ENDPATH**/ ?>