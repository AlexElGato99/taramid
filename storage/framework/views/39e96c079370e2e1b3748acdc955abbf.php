...
<section id="certs" class="py-24 lg:py-32 bg-surface">
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        <div class="text-center max-w-xl mx-auto mb-16 reveal">
            <div class="badge mx-auto mb-6"><?php echo e(setting('cert_badge', __('Quality Guarantees'))); ?></div>
            <h2 class="font-display text-heading text-ink leading-tight mb-5">
                <?php echo e(setting('cert_heading_line1', __('Certifications that'))); ?><br><?php echo e(setting('cert_heading_line2', __('prove our commitment'))); ?>

            </h2>
            <p class="text-base text-ash leading-relaxed">
                <?php echo e(setting('cert_description', __('Our products undergo the most rigorous controls, validated by independent national and international organizations.'))); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div class="card group p-6 reveal <?php echo e($index > 0 ? 'reveal-delay-' . $index : ''); ?>">
                <div class="flex flex-col items-center text-center md:flex-row md:items-start md:text-start gap-4">
                    <div class="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0">
                        <?php if($cert->icon): ?>
                            <img src="<?php echo e(asset('storage/' . $cert->icon)); ?>" alt="" class="w-12 h-12 object-contain">
                        <?php else: ?>
                            <div class="w-11 h-11 rounded-xl bg-primary flex items-center justify-center">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><?php echo $defaultIcons[$index + 1] ?? $defaultIcons[1]; ?></svg>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="flex-1">
                        <h4 class="font-display text-base text-ink font-medium mb-1"><?php echo e($cert->t('title')); ?></h4>
                        <p class="text-sm text-ash leading-relaxed"><?php echo e($cert->t('description')); ?></p>
                        <?php if($cert->t('detail_line')): ?>
...
<?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/sections/certifications.blade.php ENDPATH**/ ?>