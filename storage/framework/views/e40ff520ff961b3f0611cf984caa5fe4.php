    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div class="reveal relative">
                ...
                <?php if(setting('story_media_type', 'map') !== 'image'): ?>
            ...
            <div class="reveal reveal-delay-2">
                ...
                <div class="grid grid-cols-3 gap-3 mb-10">
                    <?php $__currentLoopData = [1, 2, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center p-4 rounded-2xl bg-surface transition-all duration-300 hover:shadow-soft">
                        <?php if(setting('story_feature'.$fi.'_icon')): ?>
                            <div class="w-10 h-10 mx-auto mb-2.5" style="background-color: #2B5F3F; -webkit-mask-image: url('<?php echo e(asset('storage/' . setting('story_feature'.$fi.'_icon'))); ?>'); -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center; mask-image: url('<?php echo e(asset('storage/' . setting('story_feature'.$fi.'_icon'))); ?>'); mask-size: contain; mask-repeat: no-repeat; mask-position: center;"></div>
                        <?php else: ?>
                            <?php echo $defaultIcons[$fi]; ?>

                        <?php endif; ?>
                        <div class="text-xs font-medium text-ink"><?php echo e(setting('story_feature'.$fi.'_label', '')); ?></div>
                    </div>
...
<?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/sections/about.blade.php ENDPATH**/ ?>