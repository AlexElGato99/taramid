...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(__('Categories')); ?></h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('Manage product categories')); ?></p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($listing->name); ?></div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5"><?php echo e($listing->slug); ?></div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($listing->products_count); ?></span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="<?php echo e(route('admin.categories.edit', $listing->id)); ?>"
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.categories.destroy', $listing->id)); ?>"
                                              onsubmit="return confirm('<?php echo e(__('Are you sure? Products in this category will become uncategorized.')); ?>')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dev_Projects\Laravel_Projects\taramid\projectfiles\allfilesbackupstaramid\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>