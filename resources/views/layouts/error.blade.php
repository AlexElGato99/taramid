<!DOCTYPE html>
<html class="dark" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ text_direction() }}">
<head>
    <meta charset="utf-8">
    ...
    <meta itemprop="name"
          content="@if(isset($config['title'])){{$config['title']}}@else{{setting('title')}}@endif">
    <meta itemprop="description"
          content="@if(isset($config['description'])){{$config['description']}}@else{{setting('description')}}@endif">
...
<div
    ...
    <div class="max-w-2xl text-center mx-auto">
        <h1 class="block font-bold text-9xl text-gray-900">@yield('code')</h1>
